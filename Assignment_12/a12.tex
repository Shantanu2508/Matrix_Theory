...
\item
	...
	\begin{align}
		\myvec{\beta_1 & \beta_2}\vec{x}=\myvec{\alpha_1 & \alpha_2} \label{a1}
	\end{align}
...
\begin{align}
	...
	\myvec{1 & 0 & | & \frac{1-i}{2} & \frac{3+i}{2} \\
	       ...
	       0 & 0 &| & 0 & 0}\\
	\implies 
	\vec{x}=\frac{1}{2}\myvec{1-i & 3+i\\ 1+i & -1+i} \label{x}
\end{align}
Thus the column vectors of (\ref{x}) are corresponding coordinates of $\alpha_1$ and $\alpha_2$ 
