...
\begin{align}
	...
	\implies \lambda=0,1
\end{align}
Such a matrix with the property that $\vec{A}^2=\vec{A}$ is an idempotent matrix with eigen values 
equal to 0 or 1. For such a matrix 
\begin{align}
	rank(A)=trace(A)
\end{align}
Now for the matrix $\vec{I}-\vec{A}$ we have,
\begin{align}
	\brak{\vec{I}-\vec{A}}^2=\brak{\vec{I}-\vec{A}}\brak{\vec{I}-\vec{A}}\\
	\implies \vec{I}^2-\vec{IA}-\vec{AI}+\vec{A}^2 \\
	\implies \vec{I}-\vec{A}-\vec{A}+\vec{A} \\
	\implies \vec{I}-\vec{A}
\end{align}
